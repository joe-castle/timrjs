...
module.exports = class Timr extends EventEmitter {
  ...
  constructor(startTime, options) {
    ...
    if (typeof startTime === 'string') {
      ...
      throw new TypeError(
        `Warning! Expected starting time to be a string or a number, instead got a(n): ${typeof startTime}`
      );
    }
  ...
  ticker(fn) {
    if (typeof fn !== 'function') {
      throw new TypeError(
        `Warning! Ticker requires a function, instead got a(n): ${typeof fn}`
      );
    }
  ...
  finish(fn) {
    if (typeof fn !== 'function') {
      throw new TypeError(
        `Warning! Finish requires a function, instead got a(n): ${typeof fn}`
      );
    }
