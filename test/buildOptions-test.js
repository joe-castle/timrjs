...
describe('Build Options Function', () => {
  ...
  it('Throws an error when outputFormat is not a string', () => {
    ...
    expect(buildOptions.bind(buildOptions, {outputFormat: {}})).to.throw('Expected outputFormat to be a string, instead got: object')
  });
  it('Throws an error when outputFormat is invalid', () => {
    expect(buildOptions.bind(buildOptions, {outputFormat: 'invalid'})).to.throw(Error)
    expect(buildOptions.bind(buildOptions, {outputFormat: 'invalid'})).to.throw('Expected outputFormat to be: HH:MM:SS, MM:SS (default) or SS, instead got: invalid')
  });
